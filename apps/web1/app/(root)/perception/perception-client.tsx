...
export function PerceptionClient({ initialData }: PerceptionClientProps) {
  ...
  return (
    <div className="grid grid-cols-12 gap-0 h-auto xl:h-full min-h-0 m-0 md:m-4">
      <div className="col-span-12 md:col-span-4 xl:col-span-3 p-2 bg-background rounded-md h-auto xl:h-full overflow-visible xl:overflow-hidden">
        <PerceptionLeftPanel
          canon={canonDraft}
      ...
      <div className="col-span-12 md:col-span-8 xl:col-span-6 h-auto xl:h-full overflow-visible xl:overflow-hidden md:px-4 border-b xl:border-b-0">
        <ScrollArea className="h-auto xl:h-full">
          ...
          <Card>
            <CardHeader className="pb-2">
              <CardTitle className="text-base">{PERCEPTION_TEXT.optimizeActions.title}</CardTitle>
              <CardDescription>
      ...
      <div className="col-span-12 xl:col-span-3 h-auto xl:h-full overflow-visible xl:overflow-hidden">
        <ScrollArea className="h-auto xl:h-full">
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-start justify-between gap-2">
        <h4 className="min-w-0 text-sm font-semibold text-foreground">{PERCEPTION_TEXT.filters.title}</h4>
      </div>

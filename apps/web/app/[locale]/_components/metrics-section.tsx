...
export function MetricsSection() {
  ...
  const metrics = [
    { value: 2847392, suffix: "", prefix: "", label: t('requests') },
    { value: 99, suffix: ".99%", prefix: "", label: t('uptime') },
    { value: 23, suffix: "ms", prefix: "", label: t('responseTime') },
    { value: 184, suffix: "", prefix: "", label: t('countries') },
  ];

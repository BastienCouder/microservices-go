...
export type ModelFilterMode = "grouped" | "unique";
...
type BooleanModelFilterModeTabsProps = Omit<
  ModelFilterModeTabsProps,
  "onValueChange" | "value"
> & {
  showUniqueModelFilters: boolean;
  onShowUniqueModelFiltersChange: (value: boolean) => void;
};
...
export function BooleanModelFilterModeTabs({
  showUniqueModelFilters,
  onShowUniqueModelFiltersChange,
  ...props
}: BooleanModelFilterModeTabsProps) {
  return (
    <ModelFilterModeTabs
      {...props}
      value={showUniqueModelFilters ? "unique" : "grouped"}
      onValueChange={(value) =>
        onShowUniqueModelFiltersChange(value === "unique")
      }
    />
  );
}

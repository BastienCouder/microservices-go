  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "group-data-[variant=default]/tabs-list:data-[state=active]:bg-linear-to-br group-data-[variant=default]/tabs-list:data-[state=active]:from-primary/95 group-data-[variant=default]/tabs-list:data-[state=active]:via-primary group-data-[variant=default]/tabs-list:data-[state=active]:to-primary/80 group-data-[variant=default]/tabs-list:data-[state=active]:text-primary-foreground group-data-[variant=default]/tabs-list:data-[state=active]:shadow-[inset_0_1px_0_hsl(var(--primary-foreground)/0.14)]",
        "group-data-[variant=line]/tabs-list:data-[state=active]:border-b-2 group-data-[variant=line]/tabs-list:data-[state=active]:border-primary group-data-[variant=line]/tabs-list:data-[state=active]:text-primary",
        className
      )}
      {...props}
    />

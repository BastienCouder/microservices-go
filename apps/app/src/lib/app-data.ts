...
export const PERCEPTION_TEXT = {
  ...
  optimizeActions: {
    title: "Briefs IA générés",
    description: "Les boutons [Générer un brief IA] à droite produisent des briefs directement exploitables.",
    empty: "Aucun brief IA généré pour le moment. Cliquez sur [Générer un brief IA] dans la colonne de droite.",
    statusPrefix: "Statut",
  ...
  topErrors: {
    ...
    seeMore: "Voir plus",
    sheetDescription: "Détail de l'erreur détectée et brief IA recommandé.",
    aiClaim: "Ce que l'IA dit",
    impact: "Impact",
    generatedFix: "Brief proposé",
    added: "Ajoutée",
    fix: "Générer un brief IA",

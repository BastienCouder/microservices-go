...
import { AIModel, ModelVisual, PeriodKey, Persona, PromptItem, PromptSort, ResponseView } from "./types";
...
export function usePromptsResponsesState() {
  ...
  }, [persona, promptSort, prompts, rangeMinutes, search, selectedModels]);

  ...
  return [
    {
      ...
      features: [
        t("starterFeatureCredits"),
        t("starterFeatureProjects"),
        t("starterFeatureModels"),
        t("starterFeatureSeats"),
        t("starterFeatureMonitoring"),
      ],
    },
    {
      id: "growth",
      ...
      features: [
        t("growthFeatureCredits"),
        t("growthFeatureProjects"),
        t("growthFeatureModels"),
        t("growthFeatureSeats"),
        t("growthFeaturePrompts"),
      ],
      highlighted: true,
    },
    {
    ...
    },
    {
      ...
      features: [
        ...
        t("enterpriseFeatureModels"),
        t("enterpriseFeatureSecurity"),
        t("enterpriseFeatureSupport"),
      ],
      custom: true,
    },
  ];

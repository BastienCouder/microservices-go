...
import type { BrandVisibilityViewModel } from "../../_lib/analytics/use-brand-visibility-view-model";
...
type BrandVisibilityPanelViewProps = {
  viewModel: BrandVisibilityViewModel;
};

export function BrandVisibilityPanelView({
  viewModel,
}: BrandVisibilityPanelViewProps) {

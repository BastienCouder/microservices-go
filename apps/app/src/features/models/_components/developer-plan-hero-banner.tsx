        ...
        <div className="flex items-start justify-between gap-3">
          <div className="max-w-[34rem]">
            <h3 className="text-xl font-semibold leading-tight tracking-tight text-white md:text-2xl">
              Activez vos propres cles API LLM pour une utilisation illimitee
            </h3>
            <p className="mt-2 text-sm text-primary-foreground/82">
              {currentPlanLabel
                ? `Vous etes actuellement sur le plan ${currentPlanLabel}.`
                : "Votre plan actuel n'inclut pas le mode Developer."}{" "}
              Passez en mode dev pour connecter OpenAI, Anthropic, Google, Mistral et
              plus, avec vos credentials.
            </p>
          </div>

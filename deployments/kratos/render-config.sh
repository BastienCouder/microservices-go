...
WEB_AUTH_URL="$(trim_trailing_slash "${WEB_AUTH_URL:-${WEB_PUBLIC_URL}/auth}")"
...
allowed_return_urls="$(append_unique_line "$allowed_return_urls" "$WEB_AUTH_URL")"
allowed_return_urls="$(append_unique_line "$allowed_return_urls" "${WEB_AUTH_URL}/callback")"
allowed_return_urls="$(append_unique_line "$allowed_return_urls" "${WEB_AUTH_URL}/login")"
allowed_return_urls="$(append_unique_line "$allowed_return_urls" "${WEB_AUTH_URL}/register")"
...
ESC_ERROR_UI_URL="$(escape_sed_replacement "$(json_quote "${WEB_AUTH_URL}/error")")"
ESC_SETTINGS_UI_URL="$(escape_sed_replacement "$(json_quote "${WEB_AUTH_URL}/settings")")"
ESC_RECOVERY_UI_URL="$(escape_sed_replacement "$(json_quote "${WEB_AUTH_URL}/recovery")")"
ESC_VERIFICATION_UI_URL="$(escape_sed_replacement "$(json_quote "${WEB_AUTH_URL}/verification")")"
ESC_VERIFICATION_RETURN_URL="$(escape_sed_replacement "$(json_quote "${WEB_PUBLIC_URL}/")")"
ESC_LOGOUT_RETURN_URL="$(escape_sed_replacement "$(json_quote "${WEB_AUTH_URL}/login")")"
ESC_LOGIN_UI_URL="$(escape_sed_replacement "$(json_quote "${WEB_AUTH_URL}/login")")"
ESC_LOGIN_RETURN_URL="$(escape_sed_replacement "$(json_quote "${APP_PUBLIC_URL}/")")"
ESC_REGISTRATION_UI_URL="$(escape_sed_replacement "$(json_quote "${WEB_AUTH_URL}/register")")"

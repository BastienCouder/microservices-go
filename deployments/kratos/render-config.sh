...
: "${KRATOS_SMTP_CONNECTION_URI:?KRATOS_SMTP_CONNECTION_URI is required}"
: "${KRATOS_SMTP_FROM_ADDRESS:?KRATOS_SMTP_FROM_ADDRESS is required}"
: "${KRATOS_SMTP_FROM_NAME:?KRATOS_SMTP_FROM_NAME is required}"
...
ESC_SMTP_CONNECTION_URI="$(escape_sed_replacement "${KRATOS_SMTP_CONNECTION_URI}")"
ESC_SMTP_FROM_ADDRESS="$(escape_sed_replacement "$(json_quote "${KRATOS_SMTP_FROM_ADDRESS}")")"
ESC_SMTP_FROM_NAME="$(escape_sed_replacement "$(json_quote "${KRATOS_SMTP_FROM_NAME}")")"
...
sed \
  ...
  -e "s|\${KRATOS_SMTP_CONNECTION_URI}|${ESC_SMTP_CONNECTION_URI}|g" \
  -e "s|\${KRATOS_SMTP_FROM_ADDRESS}|${ESC_SMTP_FROM_ADDRESS}|g" \
  -e "s|\${KRATOS_SMTP_FROM_NAME}|${ESC_SMTP_FROM_NAME}|g" \
  "${CONFIG_TEMPLATE}"

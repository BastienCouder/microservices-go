...
- Always use the latest stable version of RabbitMQ images and related tooling.
- Never use prerelease versions (`alpha`, `beta`, `rc`) unless explicitly requested.
- Verify stable tags from official RabbitMQ or Docker Hub sources before pinning versions.

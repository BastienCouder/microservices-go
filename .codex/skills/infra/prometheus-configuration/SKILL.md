...
- Always use the latest stable Prometheus/Grafana ecosystem versions available at implementation time.
- Never use `:latest` image tags; pin explicit versions in compose/manifests/examples.

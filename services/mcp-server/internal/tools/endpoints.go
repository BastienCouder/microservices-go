...
func ListEndpoints(_ context.Context, _ *mcp.CallToolRequest, _ EndpointsInput) (*mcp.CallToolResult, EndpointsOutput, error) {
	out := EndpointsOutput{
		...
		Endpoints: []Endpoint{
			...
			{Service: "organizations-service", Method: "POST", Path: "/organizations/{id}/invitations"},
			{Service: "organizations-service", Method: "GET", Path: "/organizations/{id}/invitations"},
			{Service: "organizations-service", Method: "GET", Path: "/organizations/{id}/invitations/{invitation_id}"},
			{Service: "organizations-service", Method: "PUT", Path: "/organizations/{id}/invitations/{invitation_id}"},
			{Service: "organizations-service", Method: "DELETE", Path: "/organizations/{id}/invitations/{invitation_id}"},
			{Service: "organizations-service", Method: "POST", Path: "/invitations/{token}/accept"},
			{Service: "organizations-service", Method: "POST", Path: "/invitations/{token}/refuse"},
